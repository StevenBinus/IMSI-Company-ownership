...
type Item struct {
	...
	ItemId                       int32     `gorm:"column:item_id;not null;primaryKey"        json:"item_id"`
	ItemCode                     string    `gorm:"column:item_code;size:20;not null"        json:"item_code"`
	ItemClassId                  int32     `gorm:"column:item_class_id;not null"        json:"item_class_id"` //FK dalam mtr_item_class
	ItemClass                    ItemClass `gorm:"references:item_class_id" json:"item_class"`
	ItemName                     string    `gorm:"column:item_name;size:100;null"        json:"item_name"`
	ItemGroupId                  int32     `gorm:"column:item_group_id;not null"        json:"item_group_id"` //FK Luar with mtr_item_group common-general service
	...
	SupplierId                   int32     `gorm:"column:supplier_id;not null"        json:"supplier_id"`                                 //FK luar with mtr_supplier general service
	UnitOfMeasurementTypeId      int32     `gorm:"column:unit_of_measurement_type_id;not null"        json:"unit_of_measurement_type_id"` //FK luar with mtr_unit_of_measurement_type
	UnitOfMeasurementSelling     string    `gorm:"column:unit_of_measurement_selling;size:10;null"        json:"unit_of_measurement_selling"`
	UnitOfMeasurementPurchaseId  int32     `gorm:"column:unit_of_measurement_purchase_id;null"        json:"unit_of_measurement_purchase_id"` //FK dalam with mtr_uom
	UnitOfMeasurementStockId     int32     `gorm:"column:unit_of_measurement_stock_id;null"        json:"unit_of_measurement_stock_id"`       //FK dalam with mtr_uom
	...
	DiscountId                   int32     `gorm:"column:discount_id;not null"        json:"discount_id"`           //FK dalam mtr_discount
	MarkupMasterId               int32     `gorm:"column:markup_master_id;not null"        json:"markup_master_id"` //FK dalam mtr_markup_master
	...
	DimensionUnitOfMeasurementId int32     `gorm:"column:dimension_unit_of_measurement_id;null"        json:"dimension_unit_of_measurement_id"` //FK dalam with mtr_uom
	...
	StorageTypeId                int32     `gorm:"column:storage_type_id;not null"        json:"storage_type_id"` //FK luar with storage_type general service
	Remark                       string    `gorm:"column:remark;size:512;null"        json:"remark"`
	AtpmWarrantyClaimTypeId      int32     `gorm:"column:atpm_warranty_claim_type_id;null"        json:"atpm_warranty_claim_type_id"` //FK luar with mtr_warranty_claim_type common service
	...
	SpecialMovementId            int32     `gorm:"column:special_movement_id;not null"        json:"special_movement_id"` //FK luar with mtr_special_movement common service
	...
	AtpmSupplierId               int32     `gorm:"column:atpm_supplier_id;not null"        json:"atpm_supplier_id"` //FK luar with mtr_supplier general service
	...
	GmmCatalogCode               int32     `gorm:"column:gmm_catalog_code;null"        json:"gmm_catalog_code"`
	PrincipalBrandParentId       int32     `gorm:"column:principal_brand_parent_id;not null"        json:"principal_brand_parent_id"` //FK dalam mtr_principle_brand_parent
	...
	SourceTypeId                 int32     `gorm:"column:source_type_id;null"        json:"source_type_id"`                           //fk luar with mtr_atpm_order_type common service
	AtpmSupplierCodeOrderId      int32     `gorm:"column:atpm_supplier_code_order_id;null"        json:"atpm_supplier_code_order_id"` //FK luar with mtr_supplier general service
	PersonInChargeId             int32     `gorm:"column:person_in_charge_id;null"        json:"person_in_charge_id"`                 //FK luar with mtr_user_details general service
}

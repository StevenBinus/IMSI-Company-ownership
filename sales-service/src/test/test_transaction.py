...
# from src.entities.master import CountryEntity 

# # folder_path = "src/controllers/master"
# # data = []
# # datas = []
...
# #     response = client.get(f"/api/general/{datas}")
# #     assert response.status_code == 200

# # MASTER
# # UNIT TEST GET - ALL
# def test_get_pdi_requests():
#     client = TestClient(app)
#     response = client.get(f"/api/sales/countries")
...
# def test_get_areas():
#     client = TestClient(app)
#     response = client.get(f"/api/general/areas", params={"page": 1, "page_limit": 20})
#     assert response.status_code in (200, 404)

# def test_get_provinces():
#     client = TestClient(app)
#     response = client.get(f"/api/general/provinces", params={"page": 1, "page_limit": 20})
#     assert response.status_code in (200, 404)

# def test_get_regions():
#     client = TestClient(app)
#     response = client.get(f"/api/general/region", params={"page": 1, "page_limit": 20})
#     assert response.status_code in (200, 404)
